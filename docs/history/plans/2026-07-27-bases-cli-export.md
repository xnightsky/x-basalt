...
> 2026-07-27 · 来源：[`../testing/2026-07-26-bases-implementation-status.md`](../../design/bases-status.md) §2 末行「CLI 薄出口 + guides 补 Bases 章节」；前置 P1 计划 [`2026-07-26-bases-p1-markdown-query.md`](2026-07-26-bases-p1-markdown-query.md)（已 ✅）。
> 设计真相源：[`../specs/2026-07-22-bases-headless-engine-design.md`](../../design/bases-engine.md) §4/§11/§15（API 先于 CLI；退出码策略由本计划拍板）。
