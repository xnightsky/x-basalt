...
> 设计真相源：[`../specs/2026-07-22-bases-headless-engine-design.md`](../../design/bases-engine.md)（已冻结）；验收编号：[`../testing/2026-07-22-bases-scenario-matrix.md`](../../design/bases-scenarios.md) §3。
