...
- **2026-07 更新**：新增一级单元 `src/base/`（Bases 无头引擎，P0 文档层 → P1 查询 → P2 formulas/类型/分组汇总，只读边界；all-files/context 属 P3，schema 决策见 [`../specs/2026-07-27-bases-p3-vault-entries-decision.md`](../specs/2026-07-27-bases-p3-vault-entries-decision.md)）。
