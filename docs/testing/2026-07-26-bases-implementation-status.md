...
> 性质：**living 文档**——每完成/计划一个语法项就更新本表（状态 + 日期 + 计划链接），语法事实以 [`../specs/2026-07-26-bases-syntax.md`](../specs/2026-07-26-bases-syntax.md) 为准，验收编号以 [`2026-07-22-bases-scenario-matrix.md`](2026-07-22-bases-scenario-matrix.md) 为准。
...
| 阶段 | 内容 | 状态 |
| ---- | ---- | ---- |
| P0 | document / schema / diagnostic | ✅ 2026-07-26（[计划](../plans/2026-07-26-bases-p0-document-schema.md)） |
| P1 | Markdown query vertical slice（独立 AST/evaluator） | ✅ 2026-07-26（[计划](../plans/2026-07-26-bases-p1-markdown-query.md)） |
...
> 计划：[`../plans/2026-07-26-bases-p1-markdown-query.md`](../plans/2026-07-26-bases-p1-markdown-query.md)。测试追溯：文法层 `tests/base-expression.test.ts`、求值层 `tests/base-evaluator.test.ts`、端到端 `tests/base-engine.test.ts`，用例注释均标场景编号。
...
| CLI 薄出口（`base` 命令）+ guides 补 Bases 章节 | 设计 §15（API 先于 CLI） | ✅ 2026-07-27（[计划](../plans/2026-07-27-bases-cli-export.md)；`x-basalt base` + `guides/querying-bases.md`，tests/base-cli.test.ts 7 用例） |
...
> P2a 计划：[`../plans/2026-07-27-bases-p2a-formulas.md`](../plans/2026-07-27-bases-p2a-formulas.md)；P2b 计划：[`../plans/2026-07-27-bases-p2b-types-list-group-summary.md`](../plans/2026-07-27-bases-p2b-types-list-group-summary.md)。
