...
> 本文是 `.base` 语法在 x-basalt 的**单一语法真相源**：每项语法标注实现状态（【P0 ✅】/【P1 ✅】/【P2a ✅】/【P1】/【P2】/【P3】/【不做】/【待 oracle】），逐项状态与实现时间见 [`../testing/2026-07-26-bases-implementation-status.md`](../testing/2026-07-26-bases-implementation-status.md)。
> 设计契约：[`2026-07-22-bases-headless-engine-design.md`](2026-07-22-bases-headless-engine-design.md)；场景编号：[`../testing/2026-07-22-bases-scenario-matrix.md`](../testing/2026-07-22-bases-scenario-matrix.md)。
