...
sha256: b2f82cfcbceea4f2629209a0da612e5b5ba77c1f452f25cdd963970b5c793e37
type: spec
title: scan：按需增量重索引设计
description: scan 命令增量 diff 重索引的设计规格
tags:
  - spec
  - scan
  - indexer
...
> 标尺：[`biz-dql-subset`](../../skills-def/dev/biz-dql-subset/SKILL.md)（schema / 隐式字段）
