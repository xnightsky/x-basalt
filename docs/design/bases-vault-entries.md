...
> 前置契约：[`2026-07-22-bases-headless-engine-design.md`](bases-engine.md) §13 P3 第 1 条「独立设计 `vault_entries`/附件索引，证明 DQL 不变」；验收编号：[`../testing/2026-07-22-bases-scenario-matrix.md`](bases-scenarios.md) §6（BASE-ALL-001/002）。
